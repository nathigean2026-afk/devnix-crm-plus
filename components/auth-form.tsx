    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="hidden lg:flex lg:w-[480px] xl:w-[520px] flex-col justify-between bg-[#0a0a0f] border-r border-white/[0.06] p-10 relative overflow-hidden flex-shrink-0">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="text-white font-semibold text-sm tracking-tight">Elevanthe CRM</span>
        </div>
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <Image
              ...
              className="object-contain"
            />
            <span className="font-semibold text-sm text-foreground">Elevanthe CRM</span>
          </div>
